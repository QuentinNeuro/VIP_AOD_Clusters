...
%
% S should be : Go tone (HIT AND MISS) vs noGo tone (CR AND FA)
% D should be : lick (HIT AND FA) vs nolick (CR and MISS) 
...
RewPunMultiD=As.Reward.Data;
RewPunMultiD(:,:,2)=As.Punish.Data;

firingRatesAverage=permute(RewPunMultiD,[1 3 2]);

combinedParams = {{1, [1 2]}, {2}};
margColours = [23 100 171; 187 20 25]/256;
margNames = {'Outcome', 'Condition-independent'};
